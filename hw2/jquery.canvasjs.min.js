...
*/
(function() {
    function U(a, d) { a.prototype = Pa(d.prototype);
    ...
    function ra(a) { a.indexOf || (a.indexOf = Ra);
        return a }
    ...
    function K(a, d, b, c) {
        ...
        else if (a.attachEvent) a.attachEvent("on" + d, function(c) { c = c || window.event;
    ...
    function Ma(a, d, b) {
        ...
        d = !0;
        for (b = 0; 4 > b; b++)
            if (a[b] !== a[b + 4] | a[b] !== a[b + 8] | a[b] !== a[b + 12]) { d = !1;
                break }
        return d ? a[0] <<
            16 | a[1] << 8 | a[2] : 0
    }
    ...
    function sa(a, d, b) {
        if (v && Na) {
            ...
            a.width = d * Q;
            a.height = b * Q;
            Aa !== ta && (a.style.width = d + "px", a.style.height = b + "px", c.scale(Q, Q)) } else a.width = d, a.height = b }

    function Sa(a) {
        if (!Ba) {
            var d = !1,
                b = !1;
            "undefined" === typeof ba.Chart.creditHref ? (a.creditHref = "http://canvasjs.com/",
            ...
            if ("undefined" !== typeof Blob && new Blob) {
                ...
                try {
                    window.navigator.msSaveBlob(d,
                        b), f = !0
                } catch (m) { g.dataset.downloadurl = [c, g.download, g.href].join(":"), g.href = window.URL.createObjectURL(d) }
            }
    ...
    function M(a, d, b, c) { this._defaultsKey = a;
        this.parent = c;
        ...
        if (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) {
            ...
            this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Qa(this.ctx), v ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = fa(c, f), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                ...
                "position: absolute; right: 1px; top: 1px;", this._canvasJSContainer.appendChild(this._toolBar), this.bounds = { x1: 0, y1: 0, x2: this.width, y2: this.height }, K(this.overlaidCanvas, "click", function(a) { b._mouseEventHandler(a) }), K(this.overlaidCanvas, "mousemove", function(a) { b._mouseEventHandler(a) }), K(this.overlaidCanvas, "mouseup", function(a) { b._mouseEventHandler(a) }), K(this.overlaidCanvas, "mousedown", function(a) { b._mouseEventHandler(a);
                    Y(b._dropdownMenu) }), K(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }),
        ...
        for (var b = [], c, f = 0; f < a.length; f++)
            if (0 == f) b.push(a[0]);
                ...
                var l =
                    (a[h].x - a[g].x) / c;
                c = (a[h].y - a[g].y) / c;
                b[b.length] = a[k].x > a[g].x && 0 < l || a[k].x < a[g].x && 0 > l ? { x: a[k].x + l / 3, y: a[k].y + c / 3 } : { x: a[k].x, y: a[k].y + c / 9 };
                k = f;
                g = 0 === k ? 0 : k - 1;
                h = k === a.length - 1 ? k : k + 1;
    ...
    function ia(a, d, b, c, f) { "undefined" === typeof f && (f = 0);
        this._padding = f;
        this._x1 = a;
        this._y1 = d;
        this._x2 = b;
    ...
    function W(a, d) { W.base.constructor.call(this, "TextBlock", d);
        this.ctx = a;
        this._isDirty = !0;
    ...
    function na(a, d) {
        ...
        if (x(this.options.margin) && a.options.subtitles)
            for (var b = a.options.subtitles, c = 0; c < b.length; c++)
                if ((x(b[c].horizontalAlign) && "center" === this.horizontalAlign || b[c].horizontalAlign === this.horizontalAlign) && (x(b[c].verticalAlign) && "top" === this.verticalAlign || b[c].verticalAlign === this.verticalAlign) && !b[c].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0;
                    break }
    ...
    function wa(a, d) { wa.base.constructor.call(this, "Subtitle", d, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    function S(a, d) { S.base.constructor.call(this, "ToolTip", d, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    var z = {},
        ...
        ha = {
            theme1: {
                ...
                Title: { fontFamily: v ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
                Subtitle: { fontFamily: v ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", fontSize: 16, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
                Axis: {
                    titleFontSize: 26,
                ...
                Legend: { verticalAlign: "bottom", horizontalAlign: "center", fontFamily: v ? "monospace, sans-serif,arial black" : "calibri" },
                DataSeries: { indexLabelFontColor: "grey", indexLabelFontFamily: v ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", indexLabelFontSize: 18, indexLabelLineThickness: 1 }
            },
            theme2: {
                ...
                Legend: { verticalAlign: "bottom", horizontalAlign: "center", fontFamily: v ? "monospace, sans-serif,arial black" : "arial" },
                DataSeries: { indexLabelFontColor: "grey", indexLabelFontFamily: v ? "Courier New, Courier, monospace" : "arial", indexLabelFontWeight: "bold", indexLabelFontSize: 18, indexLabelLineThickness: 1 }
            },
            theme3: {
                Chart: { colorSet: "colorSet1" },
                Title: {
                ...
                Subtitle: { fontFamily: v ? "Candara, Optima, Trebuchet MS, Helvetica Neue, Helvetica, Trebuchet MS, serif" : "calibri", fontSize: 16, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5 },
                Axis: {
                    titleFontSize: 22,
                    titleFontColor: "rgb(98,98,98)",
                ...
                Legend: { verticalAlign: "bottom", horizontalAlign: "center", fontFamily: v ? "monospace, sans-serif,arial black" : "calibri" },
                DataSeries: { bevelEnabled: !0, indexLabelFontColor: "grey", indexLabelFontFamily: v ? "Candara, Optima, Calibri, Verdana, Geneva, sans-serif" : "calibri", indexLabelFontSize: 18, indexLabelLineColor: "lightgrey", indexLabelLineThickness: 2 }
            }
        },
        E = {
            numberDuration: 1,
            ...
            for (var u = 0; k && u < k.length; u++)
                if (d = k[u], "." === d && 0 > l) l = u;
                    ...
                    if ("%" === d) h *= 100;
                        ...
                        continue } else if ("," === d[0] && "." === d[d.length - 1]) { h /= Math.pow(1E3, d.length - 1);
                        l = u + d.length - 1;
                        continue } else "E" !== d[0] && "e" !== d[0] || "0" !== d[d.length - 1] || (q = !0);
            ...
            for (q = k = u = e = l = 0; 0 < m.length;)
                if (d = m.pop(), "#" === d || "0" === d)
                    if (l++, l === p) {
                        ...
                        for (; 0 < w.length;) b = w.pop() + b, q++, 0 === q % k && (u === r && 0 < w.length) && (b = g + b) } else 0 < h.length ? (b = h.pop() + b, e++, q++) : "0" === d && (b = "0" + b, e++, q++), 0 === q % k && (u === r && 0 < h.length) && (b = g + b);
    ...
    (function() {
        ...
        z.pro = { sCH: ba[z.fSDec([178, 215, 208, 225, 227])][z.fSDec([210, 225, 212, 211, 216, 227, 183, 225, 212, 213])] };
        z.fAWm = function(a) {
            ...
            if (!Ba) try {
                ...
                a: {
                    ...
                    if (f && 0 < f.length || g) {
                        ...
                        g && (l = g);
                        h = { ckVal: Number(k[0]), lSVal: l ? Number(l.val) : null };
                        g = null;
    ...
    M.prototype.remove = function(a) {
        ...
        if (this.isOptionsInArray) {
            ...
            0 <= b && d.splice(b, 1) } else delete this.parent.options[this.optionsName];
    ...
    M.prototype.isBeingTracked = function(a) { this.options._oldOptions || (this.options._oldOptions = {});
    ...
    M.prototype.addEventListener = function(a, d, b) { a && d && (this._eventListeners[a] = this._eventListeners[a] || [], this._eventListeners[a].push({ context: b || this, eventHandler: d })) };
    M.prototype.removeEventListener = function(a, d) {
        if (a && d && this._eventListeners[a])
            for (var b = this._eventListeners[a], c = 0; c < b.length; c++)
                if (b[c].eventHandler === d) { b[c].splice(c, 1);
                    break } };
    M.prototype.removeAllEventListeners = function() { this._eventListeners = [] };
    ...
    A.prototype._updateOptions = function() {
        ...
        this.options.zoomEnabled ? (this._zoomButton || (Y(this._zoomButton = document.createElement("button")), T(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), K(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, T(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, T(a, a._zoomButton, "pan"));
            a.render() })), this._resetButton || (Y(this._resetButton = document.createElement("button")), T(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton),
        ...
        if (!this._dropdownMenu && this.exportEnabled && v) {
            ...
            K(d, "mouseover", function() { this.style.backgroundColor = "#EEEEEE" }, !0);
            K(d, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            K(d, "click", function() { a.print();
                Y(a._dropdownMenu) }, !0);
            ...
            K(d, "mouseover", function() { this.style.backgroundColor = "#EEEEEE" }, !0);
            K(d, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            K(d, "click", function() { Ca(a.canvas, "jpeg", a.exportFileName);
                Y(a._dropdownMenu) }, !0);
            d = document.createElement("div");
            d.style.cssText = "padding: 2px 15px 2px 10px";
            ...
            K(d, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            K(d, "click", function() { Ca(a.canvas, "png", a.exportFileName);
                Y(a._dropdownMenu) }, !0)
        }
            ...
            for (var d = 0; d < this.options.data.length; d++)
                if (a++, !this.options.data[d].type || 0 <= A._supportedChartTypes.indexOf(this.options.data[d].type)) {
                    ...
                    "bubble" !== b.type && "scatter" !== b.type || !b.dataPoints || (b.dataPoints.some ? b.dataPoints.some(function(a) {
                        return a.x }) && b.dataPoints.sort(Ja) : b.dataPoints.sort(Ja));
                    this.data.push(b);
                    ...
                    if (f && window.console) { window.console.log(f);
                        return }
                }
        var g = this;
        this.addEventListener("dataAnimationIterationEnd", function() { z.fAWm && z.fAWm(g);
    ...
    A.prototype.render = function(a) {
        ...
        0 < c.length ? (l.disableToolTip = !0, l._animator.animate(200, l.animationDuration, function(a) {
            ...
            f = null;
            l.disableToolTip = !1
        })) : (0 < l._indexLabels.length && l.renderIndexLabels(), l.dispatchEvent("dataAnimationIterationEnd", { chart: l }));
                ...
                for (l = 0; l < k.dataPoints.length; l++) {
                    ...
                    if (0 < l) {
                        if (a.axisX.logarithmic) {
                            ...
                            1 > q && (q = 1 / q);
                            b.minDiff > q && 1 !== q && (b.minDiff = q) } else q = c - k.dataPoints[l -
        ...
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var d =
                ...
                for (n = 0; n < m.dataPoints.length; n++) {
                    ...
                    if ((f = m.dataPoints[n].y) && f.length) { g = Math.min.apply(null, f);
                    ...
                    if (!(c < u) || p) {
                        ...
                        if (b.viewPortMin === c && f)
                            for (y = 0; y < f.length; y++)
                                if (null === f[y] && r < c) { b.viewPortMin = r;
                                    break }
    ...
    A.prototype.getDataPointAtXY = function(a, d, b) {
        ...
        for (b = 0; b < c.length; b++)
            if ("line" === c[b].dataSeries.type || "stepLine" === c[b].dataSeries.type || "area" === c[b].dataSeries.type || "stepArea" === c[b].dataSeries.type)
                if (f =
                    L("markerSize", c[b].dataPoint, c[b].dataSeries) || 8, c[b].distance <= f / 2) { d = !0;
                    break }
    ...
    A.prototype.getAutoFontSize = function(a, d, b) { a /= 400;
        return Math.max(10, Math.round(Math.min(this.width, this.height) * a)) };
    A.prototype.resetOverlayedCanvas = function() { this.overlaidCanvasCtx.clearRect(0, 0, this.width, this.height) };
    A.prototype.clearCanvas = function() { this.ctx.clearRect(0, 0, this.width, this.height);
        this.backgroundColor && (this.ctx.fillStyle = this.backgroundColor, this.ctx.fillRect(0, 0, this.width, this.height)) };
    A.prototype.attachEvent =
        function(a) { this._events.push(a) };
        ...
        if (a.changedTouches && this.interactivityEnabled) {
            ...
            if (!(b && 1 < b.length)) {
                ...
                try {
                    ...
                    if (15 < Math.abs(g) && (this._lastTouchData.scroll || 200 > h)) { this._lastTouchData.scroll = !0;
                        var k = window.parent || window;
                        k && k.scrollBy && k.scrollBy(0, -g) } } catch (l) {}
    ...
    A.prototype._dispatchRangeEvent = function(a, d) {
        ...
        for (var f = 0; f < c.length; f++)
            if (x(b[c[f]]) && (b[c[f]] = []), "axisY" === c[f])
                for (var g = 0; g < this.axisY.length; g++) b[c[f]].push({ viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum });
            else if ("axisY2" === c[f])
            for (g = 0; g < this.axisY2.length; g++) b[c[f]].push({ viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum });
        else if ("axisX" === c[f])
            ...
            for (g = 0; g < this.axisX2.length; g++) b[c[f]].push({ viewportMinimum: this[c[f]][g].sessionVariables.newViewportMinimum, viewportMaximum: this[c[f]][g].sessionVariables.newViewportMaximum });
        ...
        if (this.isDrag && "none" !== this.plotInfo.axisPlacement) {
            ...
            if ((!f || 2 < Math.abs(b) || !g || 2 < Math.abs(c)) && (this.panEnabled || this.zoomEnabled))
                if (this.panEnabled) f = {
                    ...
                    return function() { h._zoomPanToSelectedRegion(b, c, e, f, !0) && (h._dispatchRangeEvent("rangeChanging", "pan"), h.render(), h._dispatchRangeEvent("rangeChanged", "pan"), h.dragStartPoint.x = a, h.dragStartPoint.y = d) } }(f.x1, f.y1, f.x2, f.y2), 0);
    ...
    A.prototype._zoomPanToSelectedRegion = function(a, d, b, c, f) { a = this.validateRegion(a, d, b, c, f);
    ...
    A.prototype.validateRegion = function(a, d, b, c, f) {
        ...
        for (g = 0; g < m.length; g++) {
            var h = m[g],
                ...
                e = h.convertPixelToValue({ x: b, y: c });
            if (p > e) var r = e,
                e = p,
                p = r;
            if (isFinite(h.dataInfo.minDiff))
                if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) ||
                        p < h.minimum || e > h.maximum)) l.push(h), n.push({ val1: p, val2: e }), k = !0;
                else if (!f) { k = !1;
                break }
        }
    ...
    A.prototype.renderIndexLabels = function(a) {
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (m.dataSeries.indexLabelFormatter ||
                m.dataPoint.indexLabelFormatter) y = { chart: this, dataSeries: m.dataSeries, dataPoint: m.dataPoint, index: m.indexKeyword, total: w.total, percent: w.percent };
            ...
            if (null !== t && "" !== t) {
                var w = L("indexLabelPlacement", m.dataPoint, m.dataSeries),
                    ...
                    z = !1,
                    r = new W(d, { x: 0, y: 0, maxWidth: f ? f : 0.5 * this.width, maxHeight: g ? 5 * l : 1.5 * l, angle: "horizontal" === y ? 0 : -90, text: t, padding: 0, backgroundColor: r, horizontalAlign: "left", fontSize: l, fontFamily: p, fontWeight: h, fontColor: k, fontStyle: e, textBaseline: "top" });
                r.measureText();
                m.dataSeries.indexLabelMaxWidth =
                    r.maxWidth;
                if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                    if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum || m.dataPoint.y < ja.viewportMinimum || m.dataPoint.y > ja.viewportMaximum) continue } else if (0 <= n.indexOf("column")) {
                    if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum || m.bounds.y1 > b.y2 || m.bounds.y2 < b.y1) continue } else if (0 <= n.indexOf("bar")) {
                    ...
                    for (var y = !1, s = 0; s < l.length; s++)
                        if (u = l[s].x.getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y = !0;
                                ...
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: s, x1: u, y1: w };
                                ...
                                if (0 < l[s].markerSize || 0 < k.markerSize) {
                                    ...
                                    c.push(D);
                                    t = G(t);
                                    v && c.push({ x: u, y: w, ctx: b, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness }) }(l[s].indexLabel || k.indexLabel || l[s].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: l[s], dataSeries: k, point: { x: u, y: w }, direction: 0 > l[s].y === a.axisY.reversed ? 1 : -1, color: e })
                            }
                    d.stroke();
                    v && b.stroke()
                }
                    ...
                    for (var y = !1, s = 0; s < l.length; s++)
                        if (u = l[s].getTime ? l[s].x.getTime() : l[s].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !y)))
                            if ("number" !== typeof l[s].y) 0 < s && !(k.connectNullData || y || q) && (d.stroke(), v && b.stroke()), y = !0;
                                ...
                                this._eventManager.objectMap[D] = { id: D, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: s, x1: u, y1: w };
                                ...
                                if (0 < l[s].markerSize || 0 < k.markerSize) t = k.getMarkerProperties(s, u, w, d), f = t.color, c.push(t), D = G(D), v && c.push({ x: u, y: w, ctx: b, type: t.type, size: t.size, color: D, borderColor: D, borderThickness: t.borderThickness });
                                (l[s].indexLabel || k.indexLabel || l[s].indexLabelFormatter || k.indexLabelFormatter) &&
                                this._indexLabels.push({ chartType: "stepLine", dataPoint: l[s], dataSeries: k, point: { x: u, y: w }, direction: 0 > l[s].y === a.axisY.reversed ? 1 : -1, color: e })
                            }
                    d.stroke();
                    v && b.stroke()
                }
                    ...
                    for (w = !1, s = 0; s < m.length; s++)
                        if (u = m[s].getTime ? m[s].x.getTime() : m[s].x, !(u < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof m[s].y) 0 < s && !w && (l.connectNullData ? b.setLineDash && (0 < y.length && (l.options.nullDataLineDashType || !m[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, n = l.nullDataLineDashType) : (d(y), y = [])), w = !0;
                                ...
                                this._eventManager.objectMap[t] = { id: t, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: s, x1: u, y1: w };
                                y[y.length] = {
                                    x: u,
                                    y: w
                                };
                                ...
                                if (0 < m[s].markerSize || 0 < l.markerSize) {
                                    ...
                                    f.push(D);
                                    t = G(t);
                                    v && f.push({ x: u, y: w, ctx: c, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness }) }(m[s].indexLabel ||
                                    l.indexLabel || m[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: m[s], dataSeries: l, point: { x: u, y: w }, direction: 0 > m[s].y === a.axisY.reversed ? 1 : -1, color: r });
                                w = !1
                            }
                d(y)
            }
                ...
                if (0 < e.length)
                    for (var r = 5 < n && p.bevelEnabled ? !0 : !1, f = 0; f < e.length; f++)
                        if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof e[f].y) {
                            ...
                            (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "column", dataPoint: e[f], dataSeries: p, point: { x: g + (q - g) / 2, y: 0 > e[f].y === a.axisY.reversed ? h : s }, direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: g, y1: Math.min(h, s), x2: q, y2: Math.max(h, s) }, color: b })
                        }
            }
            d.restore();
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() :
                            ...
                            if (a.axisY.logarithmic) h[b] = q[k].y + (h[b] ? h[b] : 0), 0 < h[b] && (l = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : m, f[b] = l);
                                ...
                                l -= t;
                                y = m - t;
                                f[b] = t + (y - l) } else t = g[b] ? g[b] : 0, y = l + t, l = m + t, g[b] = t + (y - l);
                            b = q[k].color ? q[k].color : r._colorSet[k % r._colorSet.length];
                            N(d, u, l, w, y, b, 0, null, s && 0 <= q[k].y, 0 > q[k].y && s, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: k, x1: u, y1: l, x2: w, y2: y };
                            b = G(b);
                            ...
                            (q[k].indexLabel || r.indexLabel || q[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                dataPoint: q[k],
                                dataSeries: r,
                                point: { x: c, y: 0 <= q[k].y ? l : y },
                                direction: 0 > q[k].y === a.axisY.reversed ? 1 :
                                    -1,
                                bounds: { x1: u, y1: Math.min(l, y), x2: w, y2: Math.max(l, y) },
                                color: b
                            })
                        }
                }
                ...
                if (0 < q.length)
                    for (var s = 5 < p && r.bevelEnabled ? !0 : !1, k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            ...
                            v && N(this._eventManager.ghostCtx, u, l, w, y, b, 0, null, !1, !1, !1, !1);
                            (q[k].indexLabel ||
                                r.indexLabel || q[k].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: q[k], dataSeries: r, point: { x: c, y: 0 <= q[k].y ? l : y }, direction: 0 > q[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: u, y1: Math.min(l, y), x2: w, y2: Math.max(l, y) }, color: b })
                        }
            }
            d.restore();
            v && this._eventManager.ghostCtx.restore();
                    ...
                    if (0 < e.length) {
                        ...
                        for (f = 0; f < e.length; f++)
                            if (e[f].getTime ? k = e[f].x.getTime() : k = e[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" ===
                                ...
                                (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "bar", dataPoint: e[f], dataSeries: p, point: { x: 0 <= e[f].y ? g : s, y: h + (q - h) / 2 }, direction: 0 > e[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(s, g), y1: h, x2: Math.max(s, g), y2: q }, color: b })
                            }
                    }
                }
                d.restore();
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() :
                            ...
                            if (a.axisY.logarithmic) h[b] = q[k].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : m, f[b] = l = a.axisY.convertValueToPixel(h[b]));
                                ...
                                y = m + t;
                                l += t;
                                f[b] = t + (l - y) } else t = g[b] ? g[b] : 0, y = l - t, l = m - t, g[b] = t + (l - y);
                            b = q[k].color ? q[k].color : r._colorSet[k % r._colorSet.length];
                            N(d, y, u, l, w, b, 0, null, s, !1, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: k, x1: y, y1: u, x2: l, y2: w };
                            b = G(b);
                    ...
                    for (k = 0; k < q.length; k++)
                        if (b = q[k].x.getTime ? q[k].x.getTime() : q[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[k].y) {
                            ...
                            var w = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0,
                                y = w + p << 0;
                            if (a.axisY.logarithmic) { h[b] = u + (h[b] ? h[b] : 0);
                                if (0 >= h[b]) continue;
                                u = f[b] ? f[b] : m;
                                f[b] = l = a.axisY.convertValueToPixel(h[b]) } else if (l =
                                a.axisY.convertValueToPixel(u), 0 <= q[k].y) {
                                var t = f[b] ? f[b] : 0;
                                u = m + t;
                                l += t;
                                f[b] = t + (l - u) } else t = g[b] ? g[b] : 0, u = l - t, l = m - t, g[b] = t + (l - u);
                            b = q[k].color ? q[k].color : r._colorSet[k % r._colorSet.length];
                            N(d, u, w, l, y, b, 0, null, s, !1, !1, !1, r.fillOpacity);
                            b = r.dataPointIds[k];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: e, dataPointIndex: k, x1: u, y1: w, x2: l, y2: y };
                            b = G(b);
                            ...
                            this._indexLabels.push({ chartType: "stackedBar100", dataPoint: q[k], dataSeries: r, point: { x: 0 <= q[k].y ? l : u, y: c }, direction: 0 > q[k].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(u, l), y1: w, x2: Math.max(u, l), y2: y }, color: b })
                        }
                }
            }
            d.restore();
    ...
    A.prototype.renderArea = function(a) {
        function d() {
            t && (0 < n.lineThickness &&
                b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(), b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, v && (c.lineTo(q, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(q, s), c.beginPath(), c.moveTo(q, s), t = { x: q, y: s })
        }
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx,
                    ...
                    for (var J = !0; r < p.length; r++)
                        if (u = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !J)))
                            if ("number" !== typeof p[r].y) n.connectNullData ||
                                ...
                                e || J ? (!e && n.connectNullData ? (b.setLineDash && (n.options.nullDataLineDashType || A === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (b.stroke(), A = n.nullDataLineDashType, b.setLineDash(B)), b.lineTo(q, s), v && c.lineTo(q, s)) : (b.beginPath(), b.moveTo(q, s), v && (c.beginPath(), c.moveTo(q, s)), t = { x: q, y: s }), J = e = !1) : (b.lineTo(q, s), v && c.lineTo(q, s), 0 == r % 250 && d());
                                ...
                                this._eventManager.objectMap[H] = { id: H, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: r, x1: q, y1: s };
                                ...
                                (p[r].indexLabel || n.indexLabel || p[r].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: p[r], dataSeries: n, point: { x: q, y: s }, direction: 0 > p[r].y === a.axisY.reversed ? 1 : -1, color: D })
                            }
                    d();
                    P.drawMarkers(h);
                    n.markerColor = k
                        ...
                        for (q = !1; e < p.length; e++)
                            if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !q)))
                                if ("number" !== typeof p[e].y) 0 < e && !q && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray =
                                    ...
                                    this._eventManager.objectMap[R] = { id: R, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: e, x1: r, y1: q };
                                    y[y.length] = { x: r, y: q };
                                    ...
                                    if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < n.markerSize)) {
                                        ...
                                        h.push(J);
                                        R = G(R);
                                        v && h.push({ x: r, y: q, ctx: c, type: J.type, size: J.size, color: R, borderColor: R, borderThickness: J.borderThickness }) }(p[e].indexLabel || n.indexLabel || p[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
    ...
    A.prototype.renderStepArea = function(a) {
        function d() {
            t && (0 < n.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(),
                b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, v && (c.lineTo(q, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(q, s), c.beginPath(), c.moveTo(q, s), t = { x: q, y: s })
        }
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx,
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < m.length) {
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        q = m[p];
                        var H = null,
                            H = 0 <= t.dataPointIndexes[q] ? D[t.dataPointIndexes[q]] : { x: q, y: null };
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(),
                                ...
                                var da = k[q] ? k[q] : 0;
                                if (a.axisY.logarithmic) { n[q] = H.y + (n[q] ? n[q] : 0);
                                    if (0 >= n[q]) continue;
                                    r = a.axisY.convertValueToPixel(n[q]) } else r = a.axisY.convertValueToPixel(H.y), r -= da;
                                l.push({ x: e, y: s - da });
                                k[q] = s - r;
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || A === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), A = t.nullDataLineDashType, b.setLineDash(B)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(),
                                    u.moveTo(e, r))), J = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (d(), b.moveTo(e, r), v && u.moveTo(e, r), l.push({ x: e, y: s - da })));
                                p < D.length - 1 && (z !== (D[p].lineColor || x) || A !== (D[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, r), l.push({ x: e, y: s - da }), z = D[p].lineColor || x, b.strokeStyle = z, b.setLineDash && (D[p].lineDashType ? (A = D[p].lineDashType, b.setLineDash(I(A, t.lineThickness))) : (A = t.lineDashType, b.setLineDash(R))));
                                ...
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(t.dataPointIndexes[q], e, r, b), g = q.color, f.push(q), markerColor = G(ea), v && f.push({ x: e, y: r, ctx: u, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness }));
                                (H.indexLabel || t.indexLabel || H.indexLabelFormatter || t.indexLabelFormatter) &&
                                this._indexLabels.push({ chartType: "stackedArea", dataPoint: H, dataSeries: t, point: { x: e, y: r }, direction: 0 > D[p].y === a.axisY.reversed ? 1 : -1, color: c })
                            }
                    }
                    d();
                    b.moveTo(e, r);
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                if (0 < m.length) {
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        q = m[p];
                        var H = null,
                            H = 0 <= t.dataPointIndexes[q] ? x[t.dataPointIndexes[q]] : { x: q, y: null };
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(), J = !0;
                                ...
                                e = a.axisX.convertValueToPixel(q);
                                var ea = k[q] ? k[q] : 0;
                                if (a.axisY.logarithmic) { n[q] = da + (n[q] ? n[q] : 0);
                                    if (0 >= n[q]) continue;
                                    r = a.axisY.convertValueToPixel(n[q]) } else r = a.axisY.convertValueToPixel(da), r -= ea;
                                l.push({ x: e, y: s - ea });
                                k[q] = s - r;
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || B === t.lineDashType && t.lineDashType !==
                                    t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(E)), b.lineTo(e, r), v && u.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), v && (u.beginPath(), u.moveTo(e, r))), J = w = !1) : (b.lineTo(e, r), v && u.lineTo(e, r), 0 == p % 250 && (d(), b.moveTo(e, r), v && u.moveTo(e, r), l.push({ x: e, y: s - ea })));
                                p < x.length - 1 && (A !== (x[p].lineColor || z) || B !== (x[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, r), l.push({ x: e, y: s - ea }), A = x[p].lineColor || z, b.strokeStyle = A, b.setLineDash && (x[p].lineDashType ? (B = x[p].lineDashType,
                                    b.setLineDash(I(B, t.lineThickness))) : (B = t.lineDashType, b.setLineDash(R))));
                                if (0 <= t.dataPointIndexes[q]) {
                                    var Ga = t.dataPointIds[t.dataPointIndexes[q]];
                                    this._eventManager.objectMap[Ga] = { id: Ga, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: t.dataPointIndexes[q], x1: e, y1: r } }
                                ...
                                (H.indexLabel || t.indexLabel || H.indexLabelFormatter || t.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea100", dataPoint: H, dataSeries: t, point: { x: e, y: r }, direction: 0 > x[p].y === a.axisY.reversed ? 1 : -1, color: c })
                            }
                    }
                    d();
                    b.moveTo(e, r);
                ...
                if (m = a.dataSeriesIndexes[l], n = this.data[m], p = n.dataPoints, 0 < p.length)
                    for (d.strokeStyle = "#4572A7 ", c = 0; c < p.length; c++)
                        if (f = p[c].getTime ? f = p[c].x.getTime() : f = p[c].x, !(f < a.axisX.dataInfo.viewPortMin ||
                            ...
                            this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: c, x1: f, y1: g, size: q };
                            q = G(s);
                            v && P.drawMarker(f, g, this._eventManager.ghostCtx, e.type, e.size, q, q, e.borderThickness);
                            (p[c].indexLabel || n.indexLabel || p[c].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({ chartType: "bubble", dataPoint: p[c], dataSeries: n, point: { x: f, y: g }, direction: 1, bounds: { x1: f - e.size / 2, y1: g - e.size / 2, x2: f + e.size / 2, y2: g + e.size / 2 }, color: null })
                        }
            d.restore();
            v && this._eventManager.ghostCtx.restore();
            return {
                ...
                if (0 < m.length) {
                    ...
                    for (var n = 0, p = 0, c = 0; c < m.length; c++)
                        if (f = m[c].getTime ? f = m[c].x.getTime() : f = m[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[c].y) {
                            ...
                            d.globalAlpha =
                                1;
                            Math.sqrt((n - f) * (n - f) + (p - g) * (p - g)) < Math.min(e.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = l.dataPointIds[c], this._eventManager.objectMap[n] = { id: n, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: c, x1: f, y1: g }, n = G(n), v && P.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, n, n, e.borderThickness), (m[c].indexLabel || l.indexLabel || m[c].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: m[c],
                                dataSeries: l,
                                point: {
                    ...
                    for (var u = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? n = s[f].x.getTime() : n = s[f].x, !(n < a.axisX.dataInfo.viewPortMin ||
                            ...
                            var w = g - p / 2 << 0,
                                ...
                                x = 0 === t % 2 ? 0 : 0.5,
                                z = q.dataPointIds[f];
                            this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: f, x1: w, y1: h, x2: y, y2: k, x3: g, y3: l, x4: g, y4: m, borderThickness: t, color: c };
                            d.strokeStyle = c;
                            d.beginPath();
                            d.lineWidth = t;
                    ...
                    for (var e = 5 < k && n.bevelEnabled ? !0 : !1, f = 0; f < p.length; f++)
                        if (p[f].getTime ? h = p[f].x.getTime() : h = p[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== p[f].y && p[f].y.length && "number" === typeof p[f].y[0] && "number" === typeof p[f].y[1]) {
                            ...
                            if (c > g) {
                                ...
                                g = s }
                            s = n.dataPointIds[f];
                            this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: m, dataPointIndex: f, x1: r, y1: c, x2: q, y2: g };
                ...
                if (0 < e.length) {
                    ...
                    for (f = 0; f < e.length; f++)
                        if (e[f].getTime ?
                            ...
                            b = p.dataPointIds[f];
                            this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: f, x1: c, y1: h, x2: g, y2: q };
                            b = G(b);
                            ...
                            if (e[f].indexLabel || p.indexLabel || e[f].indexLabelFormatter || p.indexLabelFormatter) this._indexLabels.push({
                                ...
                                color: b
                            }), this._indexLabels.push({ chartType: "rangeBar", dataPoint: e[f], dataSeries: p, indexKeyword: 1, point: { x: e[f].y[1] >= e[f].y[0] ? g : c, y: h + (q - h) / 2 }, direction: e[f].y[1] >= e[f].y[0] ? 1 : -1, bounds: { x1: Math.min(c, g), y1: h, x2: Math.max(c, g), y2: q }, color: b })
                        }
                }
            }
            d.restore();
    ...
    A.prototype.renderRangeArea = function(a) {
        function d() {
            if (w) {
                ...
                b.globalAlpha = 1;
                c.fill();
                if (0 < m.lineThickness) { b.beginPath();
                    b.moveTo(a.x, a.y);
                    ...
                    for (var E = !0; e < n.length; e++)
                        if (u = n[e].x.getTime ? n[e].x.getTime() : n[e].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !E)))
                            if (null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" ===
                                ...
                                p || E ? (m.connectNullData && !p ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = B, z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, q), v && c.lineTo(r, q), k.push({ x: r, y: s })) : (b.beginPath(), b.moveTo(r, q), w = { x: r, y: q }, k = [], k.push({ x: r, y: s }), v && (c.beginPath(), c.moveTo(r, q))), E = p = !1) : (b.lineTo(r, q), k.push({ x: r, y: s }), v && c.lineTo(r, q), 0 == e % 250 && d());
                                u = m.dataPointIds[e];
                                this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: e, x1: r, y1: q, y2: s };
                                ...
                                if (0 !== n[e].markerSize && (0 < n[e].markerSize || 0 < m.markerSize)) {
                                    ...
                                    f.push(R);
                                    var J = G(u);
                                    v && f.push({ x: r, y: s, ctx: c, type: R.type, size: R.size, color: J, borderColor: J, borderThickness: R.borderThickness });
                                    R = m.getMarkerProperties(e, r, q, b);
                                    g = R.color;
                                    f.push(R);
                                    J = G(u);
                                    v && f.push({ x: r, y: q, ctx: c, type: R.type, size: R.size, color: J, borderColor: J, borderThickness: R.borderThickness }) }
                                if (n[e].indexLabel || m.indexLabel || n[e].indexLabelFormatter ||
                                    m.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeArea", dataPoint: n[e], dataSeries: m, indexKeyword: 0, point: { x: r, y: q }, direction: n[e].y[0] > n[e].y[1] === a.axisY.reversed ? -1 : 1, color: y }), this._indexLabels.push({ chartType: "rangeArea", dataPoint: n[e], dataSeries: m, indexKeyword: 1, point: { x: r, y: s }, direction: n[e].y[0] > n[e].y[1] === a.axisY.reversed ? 1 : -1, color: y })
                            } else E || p || d(), E = !0;
                    d();
                    P.drawMarkers(f);
                    m.markerColor = g
                    ...
                    for (e = !1; n < m.length; n++)
                        if (p = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!l.connectNullData ||
                            ...
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: n, x1: p, y1: e, y2: r };
                                q[q.length] = { x: p, y: e };
                                s[s.length] = { x: p, y: r };
                                ...
                                if (0 !== m[n].markerSize && (0 < m[n].markerSize || 0 < l.markerSize)) {
                                    ...
                                    f.push(B);
                                    var E = G(A);
                                    v && f.push({ x: p, y: e, ctx: c, type: B.type, size: B.size, color: E, borderColor: E, borderThickness: B.borderThickness });
                                ...
                                if (m[n].indexLabel || l.indexLabel || m[n].indexLabelFormatter || l.indexLabelFormatter) this._indexLabels.push({ chartType: "splineArea", dataPoint: m[n], dataSeries: l, indexKeyword: 0, point: { x: p, y: e }, direction: m[n].y[0] <= m[n].y[1] ? -1 : 1, color: u }), this._indexLabels.push({ chartType: "splineArea", dataPoint: m[n], dataSeries: l, indexKeyword: 1, point: { x: p, y: r }, direction: m[n].y[0] <= m[n].y[1] ? 1 : -1, color: u });
                                e = !1
    ...
    A.prototype.renderPie = function(a) {
            ...
            if (m && n) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < n.length; f++) {
                    var g =
                        n[f],
                        h = m.dataPointIds[f],
                        k = { id: h, objectType: "dataPoint", dataPointIndex: f, dataSeriesIndex: 0 };
                    r.push(k);
                    var p = { percent: null, total: null },
                        q = null,
                        p = l.getPercentAndTotal(m, g);
                    if (m.indexLabelFormatter || g.indexLabelFormatter) q = { chart: l.options, dataSeries: m, dataPoint: g, total: p.total, percent: p.percent };
                    ...
                    if (k.midAngle > Math.PI / 2 - w && k.midAngle < Math.PI / 2 + w) {
                        ...
                        a++ } else if (k.midAngle > 3 * Math.PI / 2 - w && k.midAngle < 3 * Math.PI / 2 + w) {
        ...
        function f(a) {
            for (var b = null, d = 1; d < n.length; d++)
                if (b = (a + d + r.length) % r.length, r[b].hemisphere !== r[a].hemisphere) { b = null;
                    break } else if (r[b].indexLabelText && b !== a && (0 > c(r[b], r[a]) || ("right" === r[a].hemisphere ? r[b].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y :
        ...
        function g(a, b, d) {
            ...
            if (0 <= a && a < n.length) {
                ...
                for (l = 1; l < n.length; l++)
                    if (k = (a - l + r.length) % r.length, r[k].hemisphere !== r[a].hemisphere) { k = null;
                        break } else if (r[k].indexLabelText && r[k].hemisphere === r[a].hemisphere && k !== a && (0 > c(r[k], r[a]) || ("right" === r[a].hemisphere ? r[k].indexLabelTextBlock.y <= r[a].indexLabelTextBlock.y : r[k].indexLabelTextBlock.y >= r[a].indexLabelTextBlock.y))) break;
                else k = null;
                p = k;
                m = f(a);
                l = k = 0;
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            if (0 !== v) {
                ...
                var F = Math.min(E / B, (B -
                    1) / B);
                this.pieDoughnutClickHandler = function(a) { l.isAnimating || !x(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && l._animator.animate(0, 500, function(a) { b(a);
                        k() })) };
                d();
                h();
                h();
                ...
                this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                    ...
                    l._animator.animate(0, l.animatedRender ? 500 : 0, function(a) { b(a);
                        k() }) })
            }
        }
    };
    ...
    A.prototype.exportChart = function(a) { a = "undefined" === typeof a ? {} : a;
    ...
    ia.prototype.unRegisterSpace = function(a, d) { "top" === a ? this._topOccupied -= d.height : "bottom" === a ? this._bottomOccupied -= d.height : "left" === a ? this._leftOccupied -= d.width : "right" === a && (this._rightOccupied -= d.width) };
    ...
    W.prototype.setText = function(a) { this.text = a;
        this._isDirty = !0;
        this._wrappedText = null };
    ...
    W.prototype._getFontString = function() {
        ...
        var d = this.fontFamily ? this.fontFamily + "" : "";!v && d && (d = d.split(",")[0], "'" !== d[0] && '"' !== d[0] && (d = "'" + d + "'"));
        return a += d };
    U(na, M);
    ...
    xa.prototype.render = function() {
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                ...
                for (var v = 0; v < p.dataPoints.length; v++) {
                    var t = p.dataPoints[v],
                        ...
                        e = { markerType: e, markerColor: q, text: r, textBlock: null, chartType: p.type, markerSize: s, dataSeriesIndex: n, dataPointIndex: v, markerBorderColor: u, markerBorderThickness: w };
            ...
            for (n = 0; n < l.length; n++) {
                ...
                if (!(0 >= h || "undefined" === typeof h || 0 >= r || "undefined" === typeof r)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!p || p.width + Math.round(e.textBlock.width + s + k + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) p = { items: [], width: 0 }, m.push(p), this.height += v, v = 0;
                        ...
                        "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0))), this.height < h - this.lineHeight ? (p = { items: [], width: 0 }, m.push(p)) : (p = m[t], t = (t + 1) % m.length), this.height += e.textBlock.height;
        ...
        this.items = l;
        for (n = 0; n < this.items.length; n++) e = l[n], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = { id: e.id, objectType: "legendItem", legendItemIndex: n, dataSeriesIndex: e.dataSeriesIndex, dataPointIndex: e.dataPointIndex };
            ...
            if (0 <= g && g < this.dataPoints.length) {
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "rangeColumn":
                        case "rangeBar":
                            a >= e.x1 && (a <= e.x2 && d >= e.y1 && d <= e.y2) && (c.push({ dataPoint: r, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y1 - d), Math.abs(e.y2 - d)) }),
                                k = !0);
                            break;
                        case "line":
                        case "stepLine":
                        ...
                        case "bubble":
                            s = e.size;
                            q = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - d, 2));
                            q <= s / 2 && (c.push({ dataPoint: r, dataPointIndex: g, dataSeries: this, distance: q }), k = !0);
                            break;
                        case "pie":
                        case "doughnut":
                            s = e.center;
                        ...
                        case "candlestick":
                            if (a >= e.x1 - e.borderThickness / 2 && a <= e.x2 + e.borderThickness / 2 && d >= e.y2 - e.borderThickness / 2 && d <=
                                e.y3 + e.borderThickness / 2 || Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && d >= e.y1 && d <= e.y4) c.push({ dataPoint: r, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y2 - d), Math.abs(e.y3 - d)) }), k = !0;
                            break;
                        case "ohlc":
    ...
    B.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && b && !this.logarithmic)
            ...
            for (b = this.intervalStartPosition; b <= f; b = parseFloat((this.logarithmic && this.equidistantInterval ? b * Math.pow(this.logarithmBase, this.interval) :
                    b + this.interval).toFixed(14))) a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: b, label: this.labels[b] ? this.labels[b] : null }) : "axisX" === this.type && this.labels[b] ? this.labels[b] : ca(b, this.valueFormatString, this.chart._cultureInfo), a = new W(this.ctx, {
                x: 0,
                y: 0,
                maxWidth: g,
                maxHeight: h,
    ...
    B.prototype.createLabelsAndCalculateHeight = function() {
        ...
        if ("bottom" === this._position || "top" === this._position) {
            for (b = 0; b < this._labels.length; b++) { d = this._labels[b].textBlock;
                var c = d.measureText(),
                    f = 0,
    ...
    B.setLayoutAndRender = function(a, d, b, c, f, g) {
        ...
        if ("normal" === f) {
            ...
            for (; 4 > r;) {
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) C = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, k = Math.round(g.y1 + V + L < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + L), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - X - f - C), b[e].lineCoordinates = {
                        ...
                        height: Math.abs(m -
                            k)
                    }, b[e].bounds = { x1: h - (v[e] + P), y1: k, x2: l, y2: m, width: l - h, height: m - k }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.height ? b[e].titleMaxWidth : b[e].lineCoordinates.height), P += v[e] + b[e].margin);
                if (c && 0 < c.length)
            ...
            for (; 4 > r;) {
                ...
                if (c && 0 < c.length)
                    for (e = c.length - 1; 0 <= e; e--) c[e] && (k = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + c[e].margin + Q)), c[e].lineCoordinates.y1 = m, c[e].lineCoordinates.y2 = m, c[e].bounds = { x1: h, y1: k + (c[e].margin + Q), x2: l, y2: m, width: l - h, height: U }, c[e].title && (c[e]._titleTextBlock.maxWidth = 0 <
                ...
                if (a && 0 < a.length)
                    for (e = 0; e < a.length; e++) {
                        ...
                        a[e].lineCoordinates = { x1: l - K, y1: k, x2: l - K, y2: m, height: Math.abs(m - k) };
                        a[e].bounds = {
                            x1: l - (B[e] + K),
                            y1: k,
                            x2: l,
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) {
                        ...
                        d[e].lineCoordinates = { x1: l + P, y1: k, x2: l + P, y2: m, height: Math.abs(m - k) };
                        d[e].bounds = { x1: h, y1: k, x2: l, y2: m, width: l - h, height: m - k };
            ...
            if ("bottom" === this._position || "top" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var d = [], c = 0 !== this.labelAngle &&
                            360 !== this.labelAngle ? 1 : 1.2, g, h = this.viewportMaximum, k = this.lineCoordinates.width / Math.log(this.range), l = this._labels.length - 1; 0 <= l; l--) { n = this._labels[l];
        ...
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            if (h)
                for (h = !1, c = 0; c < l.length; c++) b = l[c], b.stripLine.showOnTop ?
                    h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        for (f = 0; f < l.length; f++) b = l[f], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0) }, b.textBlock)) : "outside" === b.stripLine.labelPlacement && b.textBlock.render(!0)
        }
    };
    ...
    B.prototype.setViewPortRange = function(a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d);
            ...
            if (this.logarithmic) this.calculateLogarithamicAxisParameters();
                ...
                if (null === this.minimum || null === this.maximum)
                    if ("axisX" === this.type ? (f = null !== this.minimum ? this.minimum : this.dataInfo.min, g = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === g - f && (c = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, g += c, f -= c), h = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < g - f ? 0.5 * Math.abs(g - f) : 1) : "axisY" === this.type && (f = null !== this.minimum ? this.minimum : this.dataInfo.min, g = null !== this.maximum ? this.maximum : this.dataInfo.max, isFinite(f) ||
                        ...
                        if (null === this.maximum || isNaN(this.maximum)) this.maximum = g + h / 2 } else this.intervalType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? f - h / 2 : Math.floor(f / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)),
                ...
                if (!this.valueFormatString && (this.valueFormatString = "#,##0.##", 1 > this.range)) { d = Math.floor(Math.abs(Math.log(this.range) / Math.LN10)) + 2;
    ...
    B.prototype.calculateLogarithamicAxisParameters = function() {
        ...
        if (!this.options.interval &&
            ...
            this.interval = b } else this.options.interval || (b = Math.ceil(this.interval), this.range > this.interval && (this.interval = b, c = Math.pow(this.logarithmBase, Math.floor(Math.log(this.viewportMinimum) / (d * this.interval) + 0.2) * this.interval))), this.equidistantInterval = !0, this.intervalStartPosition = c;
        if (!this.valueFormatString &&
            (this.valueFormatString = "#,##0.##", 1 > this.viewportMinimum)) { d = Math.floor(Math.abs(Math.log(this.viewportMinimum) / Math.LN10)) + 2;
            if (isNaN(d) || !isFinite(d)) d = 2;
            if (2 < d)
                for (b = 0; b < d - 2; b++) this.valueFormatString += "#" }
    };
    ...
    B.prototype.getLabelStartPoint = function() {
        ...
        if ("millisecond" !== this.intervalType)
            ...
            if (0 < a.getSeconds() || 0 < a.getMilliseconds()) a.setMinutes(a.getMinutes() + 1), a.setSeconds(0), a.setMilliseconds(0) } else if ("hour" ===
            this.intervalType) {
            if (0 < a.getMinutes() || 0 < a.getSeconds() || 0 < a.getMilliseconds()) a.setHours(a.getHours() + 1), a.setMinutes(0), a.setSeconds(0), a.setMilliseconds(0) } else if ("day" === this.intervalType) {
            if (0 < a.getHours() || 0 < a.getMinutes() || 0 < a.getSeconds() || 0 < a.getMilliseconds()) a.setDate(a.getDate() + 1), a.setHours(0), a.setMinutes(0), a.setSeconds(0), a.setMilliseconds(0) } else if ("week" === this.intervalType) {
    ...
    oa.prototype.render = function() {
        ...
        if (0 < d) {
            ...
            if ("bottom" === this.parent._position || "top" === this.parent._position) f =
                g = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, h = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: f - d / 2, y1: h, x2: g + d / 2, y2: k };
            else if ("left" === this.parent._position || "right" === this.parent._position) h = k = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = { x1: f, y1: h - d / 2, x2: g, y2: k + d / 2 };
            this.ctx.moveTo(f, h);
            this.ctx.lineTo(g, k);
            this.ctx.stroke();
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (var k =
                            ...
                            for (var h = this.chart.axisX[k].convertPixelToValue({ y: d }), l = null, c = 0; c < this.chart.axisX[k].dataSeries.length; c++)(l = this.chart.axisX[k].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[k].dataSeries[c], null !== l.dataPoint.y && f.push(l));
                            l = null }
                    if (this.chart.axisX2)
                        for (k = 0; k < this.chart.axisX2.length; k++) {
                            h = this.chart.axisX2[k].convertPixelToValue({ y: d });
                            l = null;
                    ...
                    if (this.chart.axisX)
                        for (k = 0; k < this.chart.axisX.length; k++)
                            for (h = this.chart.axisX[k].convertPixelToValue({ x: a }), l = null, c = 0; c < this.chart.axisX[k].dataSeries.length; c++)(l = this.chart.axisX[k].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX[k].dataSeries[c], null !== l.dataPoint.y && f.push(l));
                    if (this.chart.axisX2)
                        for (k = 0; k < this.chart.axisX2.length; k++)
                            for (h =
                                this.chart.axisX2[k].convertPixelToValue({ x: a }), l = null, c = 0; c < this.chart.axisX2[k].dataSeries.length; c++)(l = this.chart.axisX2[k].dataSeries[c].getDataPointAtX(h, b)) && 0 <= l.index && (l.dataSeries = this.chart.axisX2[k].dataSeries[c], null !== l.dataPoint.y && f.push(l))
                }
                ...
                if (l = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex =
                    ...
                    if (l = Ma(a, d, this.chart._eventManager.ghostCtx), 0 < l && "undefined" !== typeof this.chart._eventManager.objectMap[l]) { l = this.chart._eventManager.objectMap[l];
                        if ("legendItem" === l.objectType) return;
                        this.currentSeriesIndex = l.dataSeriesIndex;
                        this.currentDataPointIndex = 0 <= l.dataPointIndex ? l.dataPointIndex : -1 } else this.currentDataPointIndex = -1;
                    ...
                    if (!x(l.dataPoint.y))
                        if (l.dataSeries.axisY)
                            if (0 < l.dataPoint.y.length) {
                                ...
                                b < l.dataPoint.y.length && b > -l.dataPoint.y.length && g.push(l) } else "column" === f.type || "bar" === f.type ? 0 > l.dataPoint.y ? 0 > l.dataSeries.axisY.viewportMinimum && l.dataSeries.axisY.viewportMaximum >= l.dataPoint.y && g.push(l) : l.dataSeries.axisY.viewportMinimum <=
    ...
    S.prototype.getToolTipInnerHTML = function(a) {
        ...
        for (var h = !0, k = 0; k < d.length; k++)
            if (d[k].dataSeries.toolTipContent || d[k].dataPoint.toolTipContent) { h = !1;
                break }
        if (h && (this.content && "function" === typeof this.content ||
                this.contentFormatter)) d = { chart: this.chart, toolTip: this.options, entries: d }, b = this.contentFormatter ? this.contentFormatter(d) : this.content(d);
    ...
    S.prototype.disableAnimation = function() { this.container.style.WebkitTransition && (this.container.style.WebkitTransition = "", this.container.style.MozTransition = "", this.container.style.MsTransition = "", this.container.style.transition = "") };
    ...
    S.prototype.show = function(a, d, b) { this._updateToolTip(a, d, "undefined" === typeof b ? !1 : b) };
    ...
    A.prototype.replaceKeywordsWithValue = function(a, d, b, c, f) {
        ...
        return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
            ...
            try {
                var h = a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                h && 0 < h.length && (e = la(h[2]), a = la(h[1])) } catch (k) {}
            h = null;
    ...
    ma.prototype.reset = function() { this.lastObjectId = 0;
        this.objectMap = [];
        this.rectangularRegionEventSubscriptions = [];
        this.previousDataPointEventObject = null;
        this.eventObjects = [];
    ...
    Ea.prototype.cancelAllAnimations = function() { this.animations = [];
    ...
    var F = {
        ...
        ka = {
            Chart: A,
            serialKey: null,
            addColorSet: function(a, d) { ga[a] = d },
            addCultureInfo: function(a, d) { qa[a] = d },
            formatNumber: function(a, d, b) { b = b || "en";
...
document.createElement("canvas").getContext || function() {
    ...
    var U = {
        ...
        init_: function(a) { a = a.getElementsByTagName("canvas");
    ...
    d.measureText = function(a) { this.textMeasureEl_ || (this.element_.insertAdjacentHTML("beforeEnd", '<span style="position:absolute;top:-20000px;left:0;padding:0;margin:0;border:none;white-space:pre;"></span>'), this.textMeasureEl_ = this.element_.lastChild);
...
*/
(function(b, c, d, e) { b.fn.CanvasJSChart = function(a) {
        if (a) {
            var b = this.first();
            ...
            a.render();
            return this }
        return this.first().children(".canvasjs-chart-container").data("canvasjsChartRef") } })(jQuery, window, document);
